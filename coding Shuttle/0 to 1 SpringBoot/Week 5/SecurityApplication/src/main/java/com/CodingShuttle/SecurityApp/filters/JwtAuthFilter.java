...
public class JwtAuthFilter extends OncePerRequestFilter {
	...
	// the exception will not work for the custom filer chain so we need to add it
//	   @Autowired
//	    @Qualifier("handlerExceptionResolver") // Specify the bean name you want to use
//	    private HandlerExceptionResolver handelExceptionResolver;
//	
