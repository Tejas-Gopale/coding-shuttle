	...
	// Access Token 
		public String generateAccessToken(User user) {
		    return Jwts.builder()
		            ...
		            .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 10)) // method of the 10 Mins
		...
		public String generateRefreshToken(User user) {
		    return Jwts.builder()
		            .setSubject(user.getId().toString()) // Corrected method name
		            .setIssuedAt(new Date()) // Corrected method name
		            .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 *60)) // Six  Months for the Refreshtocken	
		            .signWith(getSecretKey())
		            .compact();
		}
